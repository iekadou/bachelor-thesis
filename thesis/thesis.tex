...
\include{02_fundamentals}

\newpage{}

\include{03_state_of_the_art}
...
\bibitem{bib:palomaeki09}
  Jukka Palom\"aki
  \emph{Web Application Performance Testing}
  Master Thesis. University of Turku (2009)

\bibitem{bib:marchetto_tonella_ricca08}
  Alessandro Marchetto, Paolo Tonella and Filippo Ricca
  \emph{State-Based Testing of Ajax Web Applications}
  ICST '08 Proceedings of the 2008 International Conference on Software Testing, Verification, and Validation

\bibitem{bib:marchetto_tonella_ricca07}
  Alessandro Marchetto, Paolo Tonella and Filippo Ricca
  \emph{Testing Techniques applied to AJAX Web Applications}
  International Journal on Software Tools for Technology Transfer (STTT)
  
  
\bibitem{bib:bozdag_mesbah_vanDeursen08}
  Engin Bozdag, Ali Mesbah and Arie van Deursen
  \emph{Performance Testing of Data Delivery Techniques for AJAX Applications}
  TUD-SERG Technical Report Series, Journal of Web Engineering
