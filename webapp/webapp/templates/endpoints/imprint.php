    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                <h1 class="page-header"><?php echo getTranslation('Imprint'); ?></h1>
                <p>Jonas Braun<br>
                    Bienenstück 18<br>
                    56072 Koblenz<br>
                    E-Mail: jbraun@uni-koblenz.de<br>
                    Tel: 0160 94858125</p>
                ...
                <p>Diese Website benutzt Google Analytics mit der Zusatzfunktion „anonymizeIP()“. Dies bedeutet, dass IP-Adressen nicht vollständig, sondern nur gekürzt gespeichert und verarbeitet werden, um einen direkten Rückschluss auf die Person auszuschließen.</p>
                <p><i><a href="http://www.agb.de">Gratis Impressum</a> von agb.de</i></p>
            </div>
        </div>
    </div>
</div>
