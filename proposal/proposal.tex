...
\section{State of the art}
  ...
  A good way to implement \ajax{} in websites use the pattern of HIJAX.
  It says to plan with \ajax{} from the start of building the website but build it without and after the website is finished without \ajax{} you add it afterwards. This should then be done by \emph{hijacking} an event like a click to then handle it by an additional script.

  
\section{\pjaxr{}}
  \subsection{Requirements}
  The idea of \pjaxr{} was to have the advantages of \ajax{} while trying to avoid it's disadvantages.
  ...
  Additionally \pjaxr{} should be a generic solution for a whole \singlePageApplication{}, not just for one site.
  ...
  Every level in the hierarchy has it's counterpart on the website, a container with an id, telling which part of the namespace it is.
  Every request is enriched with the current website's namespace.
  ...
  The content delivered by the \pjaxr{} backend is interpreted and replaces tags with matching IDs.
